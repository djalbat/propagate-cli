...
const INVALID_ANSWER_MESSAGE = 'You must answer (y)es or (n)o.',
      ...
      PUBLISHING_MESSAGE = 'Publishing...',
      NO_DIRECTORIES_MESSAGE = 'There are no additional directories.',
      NO_RELEASE_PRESENT_MESSAGE = 'Either the sub-directory is missing or it does not contain a package.json file.',
      RELEASE_NOT_BUILDABLE_MESSAGE = 'The package or binary cannot be built because it depends, most likely indirectly, on itself.',
      ...
      PUBLISHING_REMAINING_RELEASES_MESSAGE = 'Publishing remaining packages...',
...
module.exports = {
  ...
  RELEASE_NOT_BUILDABLE_MESSAGE,
  RELEASE_NOT_PUBLISHABLE_MESSAGE,
  NO_SUB_DIRECTORY_SPECIFIED_MESSAGE,
  PUBLISHING_REMAINING_RELEASES_MESSAGE,
