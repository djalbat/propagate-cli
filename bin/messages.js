...
const INVALID_ANSWER_MESSAGE = 'You must answer (y)es or (n)o.',
      ...
      FAILED_SET_TERMINAL_COMMANDS_MESSAGE = 'Failed to set the terminal command sequences',
      ...
      SUCCESSFUL_SET_TERMINAL_COMMANDS_MESSAGE = 'The terminal command sequences have been set successfully',
...
module.exports = {
  ...
  SUCCESSFUL_SET_TERMINAL_COMMANDS_MESSAGE,
