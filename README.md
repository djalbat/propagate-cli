...
Managing dependencies in a project can be irksome if your project relies on more than a few frequently updated packages. Consider the following dependency graph. The solid lines represent dependencies, dotted lines so-called 'dev' dependencies:
