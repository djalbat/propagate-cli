...
import addIgnoredDependencyPromptOperation from "../operation/prompt/addIgnoredDependency";

import { executeOperations } from "../utilities/operation";
import { retrieveIgnoredDependencies, updateIgnoredDependencies } from "../configuration";
import { FAILED_ADD_IGNORED_DEPENDENCY_MESSAGE,
         SUCCESSFUL_ADD_IGNORED_DEPENDENCY_MESSAGE,
         IGNORED_DEPENDENCIES_INCLUDE_IGNORED_DEPENDENCY_MESSAGE } from "../messages";

export default function addIgnoredDependencyAction() {
  const operations = [
